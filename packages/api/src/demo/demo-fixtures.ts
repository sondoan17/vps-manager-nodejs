  ...
  return [
    {
      ...
      networkTx: 93_200,
      uptime: 691_200,
      collectedAt: secondsAgo(30),
      freshness: "fresh",
      trend: {
        range: "1h",
        points: [18, 28, 22, 24, 30, 26],
        min: 18,
        max: 30,
        threshold: 90,
        unit: "cpu",
    ...
    },
    {
      ...
      networkTx: 0,
      uptime: 0,
      collectedAt: minutesAgo(140),
      freshness: "stale",
      trend: {
        range: "2h",
        points: [68, 70, 72, 74, 74, 73],
        min: 68,
        max: 74,
        threshold: 85,
        unit: "disk",
  ...
  return [
    {
      ...
      retryCount: 0,
      outputPreview: "Waiting for the active metrics collection to finish.",
    },
    {
      ...
      errorLogUrl: "https://example.com/demo/logs/job_demo_collect_metrics.txt",
    },
    {
      ...
      durationMs: 60_000,
      retryCount: 1,
      outputPreview: "Key verification succeeded.",
    },
    {
      ...
      exitCode: 255,
      workerId: "worker-crypto-01",
      durationMs: 60_000,
      retryCount: 2,
      errorMessage: "SSH connection timed out while rotating the key.",
      errorLogUrl:
        "https://example.com/demo/logs/job_demo_rotate_key_failed.txt",
      outputPreview: "Host unreachable after two retry attempts.",
    },
  ];
}
...
export const demoAuditEvents: readonly AuditEvent[] = [
  {
    ...
    eventCode: "dashboard.viewed",
    resourceType: "dashboard",
    result: "success",
    timestamp: DEMO_TIME,
    severity: "info",
    actionLabel: "Dashboard viewed",
    sourceIp: "10.8.0.24",
    requestId: "req_demo_001",
    client: "demo-browser",
    authMethod: "demo-session",
    metadata: { mode: "demo" },
  },
  {
    id: "audit_demo_job_queued",
    actor: "system",
    action: "job.queued",
    eventCode: "job.queued",
    resourceType: "job",
    resourceId: "job_demo_disk_check",
    jobId: "job_demo_disk_check",
    result: "success",
    timestamp: "2026-06-24T11:59:00.000Z",
    severity: "info",
    actionLabel: "Job queued",
    serverLabel: "worker-sfo-01",
    sourceIp: "demo-worker-sfo-01",
    requestId: "req_demo_002",
  },
  {
    id: "audit_demo_job_running",
    actor: "system",
    action: "job.running",
    eventCode: "job.started",
    resourceType: "job",
    resourceId: "job_demo_collect_metrics",
    jobId: "job_demo_collect_metrics",
    result: "success",
    timestamp: "2026-06-24T11:59:30.000Z",
    severity: "info",
    actionLabel: "Job started",
    serverLabel: "edge-sgp-01",
    sourceIp: "demo-worker-metrics-01",
    requestId: "req_demo_003",
  },
  {
    id: "audit_demo_job_succeeded",
    actor: "system",
    action: "job.succeeded",
    eventCode: "job.completed",
    resourceType: "job",
    resourceId: "job_demo_verify_key",
    jobId: "job_demo_verify_key",
    result: "success",
    timestamp: "2026-06-24T11:55:03.000Z",
    severity: "info",
    actionLabel: "Job completed",
    serverLabel: "api-fra-02",
    durationMs: 60000,
    sourceIp: "demo-worker-crypto-02",
    requestId: "req_demo_004",
  },
  {
    id: "audit_demo_job_failed",
    actor: "system",
    action: "job.failed",
    eventCode: "job.failed",
    resourceType: "job",
    resourceId: "job_demo_rotate_key_failed",
    jobId: "job_demo_rotate_key_failed",
    result: "failure",
    timestamp: "2026-06-24T10:40:00.000Z",
    severity: "critical",
    actionLabel: "Job failed",
    serverLabel: "worker-sfo-01",
    durationMs: 60000,
    sourceIp: "demo-worker-crypto-01",
    requestId: "req_demo_005",
    reason: "SSH connection timed out while rotating the key.",
  },
  {
    id: "audit_demo_terminal_opened",
    actor: "demo",
    action: "terminal.opened",
    eventCode: "terminal.opened",
    resourceType: "terminal",
    result: "success",
    timestamp: "2026-06-24T11:58:00.000Z",
    severity: "info",
    actionLabel: "Terminal session",
    serverLabel: "edge-sgp-01",
    durationMs: 720000,
    sourceIp: "10.8.0.24",
    ...
    authMethod: "demo-session",
    metadata: { mode: "canned-demo" },
  },
  {
    id: "audit_demo_host_blocked",
    actor: "system",
    action: "ssh.host.blocked",
    eventCode: "ssh.host_blocked",
    resourceType: "vps",
    resourceId: "demo-worker-sfo-01",
    result: "blocked",
    timestamp: "2026-06-24T10:40:00.000Z",
    severity: "critical",
    actionLabel: "SSH host blocked",
    serverLabel: "worker-sfo-01",
    sourceIp: "demo-worker-sfo-01",
    requestId: "req_demo_007",
    authMethod: "ssh-key",
    reason: "repeated failed key verification",
    metadata: { reason: "repeated failed key verification" },
  },
] as const;
  ...
  sessions: [
    {
      command: "uptime",
      output:
        "12:00:00 up 8 days, 4:12, 1 user, load average: 0.41, 0.37, 0.35",
    },
